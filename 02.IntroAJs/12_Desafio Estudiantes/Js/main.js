...
//creamos la funcion para calcular el promedio de la planilla
function CalcularPromedio(){
    ...
    document.getElementById('promedioGrupo').innerText = `El promedio general del grupo es ${promedioGeneral}`;
}